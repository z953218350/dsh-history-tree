  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      var CSS_TEXT = [
        ...
        '  width: 8px;',
        '  height: 2px;',
        '  background: color-mix(in srgb, var(--dsw-alias-label-primary, #0f1115) 24%, transparent);',
        '  border-radius: 1px;',
        '  pointer-events: none;',
        ...
        '  box-shadow: 0 0 8px color-mix(in srgb, var(--dsw-alias-label-primary, #0f1115) 45%, transparent);',
        '}',
        '.dsh-ht-dash[data-dist="1"] {',
        '  width: 19px;',
        '  height: 2.2px;',
        '  background: color-mix(in srgb, var(--dsw-alias-label-primary, #0f1115) 75%, transparent);',
        '}',
        '.dsh-ht-dash[data-dist="2"] {',
        '  width: 14px;',
        '  height: 2px;',
        '  background: color-mix(in srgb, var(--dsw-alias-label-primary, #0f1115) 52%, transparent);',
        '}',
        '.dsh-ht-dash[data-dist="3"] {',
        '  width: 10px;',
        '  height: 2px;',
        '  background: color-mix(in srgb, var(--dsw-alias-label-primary, #0f1115) 36%, transparent);',
        '}',
        '',
        ...
        '  border-radius: 10px;',
        '  box-shadow: var(--dsw-shadow-lv2, 0 16px 36px rgba(0, 0, 0, 0.15)), 0 0 0 1px var(--dsw-alias-border-l1, rgba(0, 0, 0, 0.04));',
        '  padding: 12px 14px;',
        ...
        '}',
        'body[data-ds-dark-theme] .dsh-ht-card {',
        ...
        '}',
        'body[data-ds-dark-theme] .dsh-ht-card-title {',
        '  color: var(--dsw-alias-label-primary, #ffffff);',
        '}',
        'body[data-ds-dark-theme] .dsh-ht-card-body {',
        '  color: var(--dsw-alias-label-secondary, #9ca3af);',
        '}',
        'body[data-ds-dark-theme] .dsh-ht-card-footer {',
        '  border-top-color: var(--dsw-alias-border-l1, rgba(255, 255, 255, 0.08));',
        '  color: var(--dsw-alias-label-tertiary, #86909c);',
        '}',
